...
function overviewFixture(patch: Partial<AnalyticsOverview> = {}): AnalyticsOverview {
  return {
    ...
    personalExpense: paise(48250),
    income: paise(120000),
    transfers: paise(10000),
    moneyLent: 0,
    repaymentsReceived: 0,
    moneyBorrowed: 0,
    repaymentsMade: 0,
    netCashFlow: paise(71750),
    spendingChange: { amount: paise(10250), percent: 27.0, direction: 'up', text: '₹10,250 higher than August (27%)' },
    incomeChange: { amount: paise(20000), percent: 20.0, direction: 'up', text: '₹20,000 higher than August (20%)' },
    transactionCountChange: { amount: 6, percent: 16.7, direction: 'up', text: '6 more transactions than August' },
    categoryBreakdown: [],
    dailySpending: [],
    topMerchants: [],
    accountBreakdown: [],
    peopleSummary: { totalOwedToMe: 0, totalIOwe: 0, netBalance: 0, activePeopleCount: 0, people: [] },
    recurringSummary: { estimatedMonthlyCost: 0, upcomingCount: 0, upcoming: [] },
    ...patch,
  };
}
